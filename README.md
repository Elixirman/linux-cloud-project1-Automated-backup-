...
|---|---------|--------|-----------|--------|
| 1 | [Automated Backup Script](projects/01-automated-backup-script/index.html) | ✅ Complete | [View](https://YOUR_USERNAME.github.io/YOUR_REPO_NAME/projects/01-automated-backup-script/) | `tar`, `gzip`, variables, exit codes, permissions |
